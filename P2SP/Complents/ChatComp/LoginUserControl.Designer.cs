...
namespace Complents.ChatComp
{
	partial class LoginUserControl
	{
		...
		private void InitializeComponent()
		{
			...
			this.mainBackground.Location = new System.Drawing.Point(10, 5);
			this.mainBackground.Margin = new System.Windows.Forms.Padding(0);
			this.mainBackground.MaximumSize = new System.Drawing.Size(80, 77);
			this.mainBackground.MinimumSize = new System.Drawing.Size(80, 77);
			this.mainBackground.MouseBack = null;
			this.mainBackground.Name = "mainBackground";
			this.mainBackground.NormlBack = null;
			this.mainBackground.Padding = new System.Windows.Forms.Padding(2);
			this.mainBackground.Radius = 5;
			this.mainBackground.Size = new System.Drawing.Size(80, 77);
			this.mainBackground.TabIndex = 0;
			this.mainBackground.MouseLeave += new System.EventHandler(this.SetBtnRemoveDisable);
			this.mainBackground.Click += new System.EventHandler(this.ClickLoginUserControl);
			this.mainBackground.MouseEnter += new System.EventHandler(this.SetBtnRemoveVisible);
			// 
			// headImage
			// 
			...
			this.headImage.Location = new System.Drawing.Point(20, 20);
			this.headImage.Margin = new System.Windows.Forms.Padding(0);
			this.headImage.MaximumSize = new System.Drawing.Size(40, 40);
			this.headImage.MouseBack = null;
			this.headImage.Name = "headImage";
			this.headImage.NormlBack = null;
			this.headImage.Size = new System.Drawing.Size(40, 40);
			this.headImage.TabIndex = 0;
			this.headImage.MouseLeave += new System.EventHandler(this.SetBtnRemoveDisable);
			this.headImage.Click += new System.EventHandler(this.ClickLoginUserControl);
			this.headImage.MouseEnter += new System.EventHandler(this.SetBtnRemoveVisible);
			// 
			// cbIsChecked
			// 
			...
			this.cbIsChecked.DownBack = global::Complents.Resource.checkbox_pushed;
			...
			this.cbIsChecked.Location = new System.Drawing.Point(2, 0);
			this.cbIsChecked.Margin = new System.Windows.Forms.Padding(0);
			this.cbIsChecked.MouseBack = global::Complents.Resource.checkbox_hightlight;
			this.cbIsChecked.Name = "cbIsChecked";
			this.cbIsChecked.NormlBack = global::Complents.Resource.checkbox_normal;
			this.cbIsChecked.SelectedDownBack = global::Complents.Resource.checkbox_tick_pushed;
			this.cbIsChecked.SelectedMouseBack = global::Complents.Resource.checkbox_tick_highlight;
			this.cbIsChecked.SelectedNormlBack = global::Complents.Resource.checkbox_tick_pushed;
			this.cbIsChecked.Size = new System.Drawing.Size(31, 21);
			...
			this.btnState.DownBack = global::Complents.Resource.btnState_DownBack;
			this.btnState.DrawType = CCWin.SkinControl.DrawStyle.Img;
			this.btnState.Image = global::Complents.Resource.online;
			this.btnState.Location = new System.Drawing.Point(61, 58);
			this.btnState.Margin = new System.Windows.Forms.Padding(0);
			this.btnState.MouseBack = global::Complents.Resource.btnState_MouseBack;
			...
			this.menuStripState.Size = new System.Drawing.Size(95, 114);
			...
			// 在线ToolStripMenuItem
			// 
			this.在线ToolStripMenuItem.Image = global::Complents.Resource.online;
			...
			this.在线ToolStripMenuItem.Size = new System.Drawing.Size(94, 22);
			this.在线ToolStripMenuItem.Text = "在线";
			// 
			// 离开ToolStripMenuItem
			// 
			this.离开ToolStripMenuItem.Image = global::Complents.Resource.away_;
			...
			this.离开ToolStripMenuItem.Size = new System.Drawing.Size(94, 22);
			this.离开ToolStripMenuItem.Text = "离开";
			// 
			// 隐身ToolStripMenuItem
			// 
			this.隐身ToolStripMenuItem.Image = global::Complents.Resource.invisible_;
			...
			this.隐身ToolStripMenuItem.Size = new System.Drawing.Size(94, 22);
			this.隐身ToolStripMenuItem.Text = "隐身";
			// 
			// 离线ToolStripMenuItem
			// 
			this.离线ToolStripMenuItem.Image = global::Complents.Resource.offline_;
			...
			this.离线ToolStripMenuItem.Size = new System.Drawing.Size(94, 22);
			this.离线ToolStripMenuItem.Text = "离线";
			// 
			// 忙碌ToolStripMenuItem
			// 
			this.忙碌ToolStripMenuItem.Image = global::Complents.Resource.busy_;
			...
			this.忙碌ToolStripMenuItem.Size = new System.Drawing.Size(94, 22);
			...
			this.lblNickName.Location = new System.Drawing.Point(0, 87);
			...
			this.MaximumSize = new System.Drawing.Size(100, 110);
