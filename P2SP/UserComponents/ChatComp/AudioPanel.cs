...
namespace UserComponents.ChatComp
{
	...
	public partial class AudioPanel : UserControl
	{
		...
		public void SetAccecpt()
		{
			...
			this.btnCancel.Image = UserComponents.ChatCompResource.hang;
		...
		void BtnVoiceClick(object sender, EventArgs e)
		{
			...
			{
				this.btnVoice.Image = UserComponents.ChatCompResource.sound_disable;
			}
			else
			{
				this.btnVoice.Image = UserComponents.ChatCompResource.sound_enable;
			}
		...
		void BtnMicClick(object sender, EventArgs e)
		{
			...
			{
				this.btnMic.Image = UserComponents.ChatCompResource.mic_disable;
			}
			else
			{
				this.btnMic.Image = UserComponents.ChatCompResource.mic_enable;
			}
