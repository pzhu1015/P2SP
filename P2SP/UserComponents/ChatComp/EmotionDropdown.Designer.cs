...
namespace UserComponents.ChatComp
{
	partial class EmotionDropdown
	{
		...
		private void InitializeComponent()
		{
			...
			this.ecDefault = new UserComponents.ChatComp.EmotionContainer();
			...
			this.ecDefault.ItemClick += new UserComponents.ChatComp.EmotionItemMouseEventHandler(this.EcDefaultItemClick);
			// 
			// tabPage2
			// 
		...
		private UserComponents.ChatComp.EmotionContainer ecDefault;
